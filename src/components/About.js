...
const About = () => (
    <div className="about-container">
        ...
        <p>
            ...
            of these: General (beginner), Technician (intermediate), and Extra (advanced).
        </p>
        ...
        <p>For taking the actual test:
            <p>
                <a
                    ...
                    href="http://www.arrl.org/find-an-amateur-radio-license-exam-session">
                    Find an Amateur Radio License Exam Location in Your Area</a>.</p>
        </p>
